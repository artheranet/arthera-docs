...
---
Each transaction on Artera requires a transaction fee paid to the network in order to prevent spam attacks. The fee is paid in Arhtera's native token AA.
