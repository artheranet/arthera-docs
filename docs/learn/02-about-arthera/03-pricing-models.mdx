...
<Alert severity='info'>
  <strong>Subscriptions are also ERC721-compatible tokens (NFTs)</strong> and they can be transferred between accounts, as long as the account does not have more than *one* subscription.
</Alert>
<br/>
