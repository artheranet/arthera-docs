...
<Alert severity='warning'>
    You need to have an active on-chain subscription to Arthera for your customers to make gas-less transactions.
</Alert>
<br/>

To make thing even more streamlined, the Arthera chain allows users to work with your DApp without even owning AA or any other cryptocurrency.
