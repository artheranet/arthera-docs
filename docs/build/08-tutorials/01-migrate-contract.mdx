...
2. Create an account using the [Arthera Wallet](https://wallet-test.arthera.net) and get some testnet AA coins from the [Testnet Faucet](https://faucet-test.arthera.net/) or directly from the wallet.
