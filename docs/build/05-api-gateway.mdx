...
* **`/rest/offline-validators`**  displays a list of validators that are down

* **`/rest/account?addr=0x...`** returns detailed information for the provided address as a JSON object with the following structure:
