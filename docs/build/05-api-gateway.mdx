...
<Alert severity="info">
  ...
  <ul>
    <li>
      <Link href={"https://apigw-test2.arthera.net"}>
        https://apigw-test2.arthera.net
      </Link>
    </li>
    <li>
      <Link href={"https://gw-eu2-test.arthera.net"}>
        https://gw-eu2-test.arthera.net
      </Link>
    </li>
    <li>
      <Link href={"https://gw-us-test.arthera.net"}>
        https://gw-us-test.arthera.net
      </Link>
    </li>
  </ul>
</Alert>
...
You can play around and test GraphQL queries by opening the [**/graphi**](https://apigw-test2.arthera.net/graphi) endpoint on each API gateway.
...
- [**/rest/gas**](https://apigw-test2.arthera.net/rest/gas) returns a JSON structure with current gas price info:
  ...
  ```shell
  curl "https://apigw-test2.arthera.net/rest/gas"
  ```

- [**/rest/account**](https://apigw-test2.arthera.net/rest/account?addr=0x3BD2DeC1Dd270d5673eFFd3cC30fD13445e964aD) returns detailed information for the provided address:
  ...
  - _Example_:
    ```bash
    curl "https://apigw-test2.arthera.net/rest/account?addr=0x3BD2DeC1Dd270d5673eFFd3cC30fD13445e964aD"
    ```

- [**/rest/balanceof**](https://apigw-test2.arthera.net/rest/balanceof) returns the balance of an ERC20, ERC721 or ERC1155 token for the provided address:
  ...
  ```bash
  curl "https://apigw-test2.arthera.net/rest/balanceof?type=erc1155&addr=0x3BD2DeC1Dd270d5673eFFd3cC30fD13445e964aD&token=0x000000000000000000000000000000000000Aa07&tokenId=0x1"
  ```
