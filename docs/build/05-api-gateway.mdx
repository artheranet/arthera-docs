...
* [**/rest/account?addr=0x...**](https://gw-eu1-test.arthera.net/rest/account?addr=0x3BD2DeC1Dd270d5673eFFd3cC30fD13445e964aD) returns detailed information for the provided address as a JSON object with the following structure:
    ...
    * `erc20Tokens` - array of ERC20 tokens owned by the account
    * `erc721Tokens` - array of ERC20 tokens owned by the account
    * `erc1155Tokens` -  array of ERC20 tokens owned by the account
