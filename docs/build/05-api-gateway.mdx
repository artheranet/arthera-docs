...
<Alert severity='info'>
    <p>The Testnet has the following available API Gateway endpoints:</p>
    <ul>
        <li><Link href={'https://gw-eu1-test.arthera.net'}>https://gw-eu1-test.arthera.net</Link></li>
        <li><Link href={'https://gw-eu2-test.arthera.net'}>https://gw-eu2-test.arthera.net</Link></li>
        <li><Link href={'https://gw-us-test.arthera.net'}>https://gw-us-test.arthera.net</Link></li>
    </ul>
</Alert>
...
type Query {
    ...
    delegationsOf(validator:BigInt!, cursor: Cursor, count: Int = 25): DelegationList!
    ...
    stakingRewardsCollectedAmount(delegator: Address, validator: BigInt, since: Long, until: Long): BigInt!
    ...
    erc20TokenAllowance(token: Address!, owner: Address!, spender: Address!):BigInt!
...
### Interactive console
You can play around and test GraphQL queries by opening the [**/graphi**](https://gw-eu1-test.arthera.net/graphi) endpoint on each API gateway.
...
* [**/rest/gas**](https://gw-eu1-test.arthera.net/rest/gas) returns a JSON structure with current gas price info:
  ...
  * _Example_:
  ```shell
  curl "https://gw-eu1-test.arthera.net/rest/gas"
  ```
* [**/rest/account**](https://gw-eu1-test.arthera.net/rest/account?addr=0x3BD2DeC1Dd270d5673eFFd3cC30fD13445e964aD) returns detailed information for the provided address:
  * _Input_:
  ...
  * _Example_:
    ```bash
    curl "https://gw-eu1-test.arthera.net/rest/account?addr=0x3BD2DeC1Dd270d5673eFFd3cC30fD13445e964aD"
    ```
* [**/rest/balanceof**](https://gw-eu1-test.arthera.net/rest/balanceof) returns the balance of an ERC20, ERC721 or ERC1155 token for the provided address:
  * _Input_:
    * `addr` - 0x-prefixed account address as a URL parameter
  ...
  * _Example_:
  ```bash
  curl "https://gw-eu1-test.arthera.net/rest/balanceof?type=erc1155&addr=0x3BD2DeC1Dd270d5673eFFd3cC30fD13445e964aD&token=0x000000000000000000000000000000000000Aa07&tokenId=0x1"
  ```
