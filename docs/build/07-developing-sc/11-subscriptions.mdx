...
using the [whitelistAccount()](/build/developing-sc/system-contracts/Subscribers#whitelistaccount) method available in the [Subscribers](/dapp/developing-sc/system-contracts/Subscribers) system contract.
