...
Arthera will launch its Mainnet in **October 2023**. As you know, the best way to get ready for this is to test your app as much as possible (Solidity contracts and interfaces) using Arthera Testnet. Following the current development best practices, we invite you to follow the steps described below.
...
4. [End-to-end tests II](./integration-recommendations#4-end-to-end-tests)
...
There's nothing easier than an Arthera subs integration. A new tutorial will be published in the coming days, but you already can go ahead and follow [this tutorial](../tutorials/use-subscriptions). To recap, you want to:

- Subscribe your app [here](https://wallet-test.arthera.net/)
- Edit your contract (as shown on [this page](../tutorials/use-subscriptions))
- Test it
- Deploy it
