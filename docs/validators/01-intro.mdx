---
title: Arthera Validators
description: Secure the Arthera network by validating transactions
---
...
A validators needs a minimum amount of AA coins to be able to join the network.
They also have a maximum cap based on how much coins they have staked:

* Minimum stake: 500,000 AA
* Maximum stake: 15 * _Minimum stake_
